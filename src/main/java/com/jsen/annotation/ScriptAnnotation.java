...
import com.jsen.exceptions.ScriptAnnotationException;
...
public class ScriptAnnotation {
	 ...
	 */
	public static boolean isEngineSupported(Class<?> clazz, Member member, AbstractScriptEngine scriptEngine) {
	 ...
	 */
	public static boolean isEngineSupported(Annotation annotation, AbstractScriptEngine scriptEngine) {
	 ...
	 */
	public static boolean testForScriptGetter(Class<?> clazz, Method method, AbstractScriptEngine scriptEngine) {
	 ...
	 */
	public static boolean testForScriptSetter(Class<?> clazz, Method method, AbstractScriptEngine scriptEngine) {
		Class<?>[] parameterTypes = method.getParameterTypes();
	 ...
	 */
	public static boolean testForScriptConstructor(Class<?> clazz, Constructor<?> constructor, AbstractScriptEngine scriptEngine) {
	 ...
	 */
	public static boolean testForScriptFunction(Class<?> clazz, Method method, AbstractScriptEngine scriptEngine) {
	 ...
	 */
	public static boolean testForScriptField(Class<?> clazz, Field field, AbstractScriptEngine scriptEngine) {
	 ...
	 */
	public static boolean testForObjectGetter(Class<?> clazz, Method method, AbstractScriptEngine scriptEngine) {
	...
	public static String extractFunctionName(Method method) {
		...
		if (annotation instanceof ScriptFunction) {
			ScriptFunction functionAnnotation = (ScriptFunction) annotation;
			functionName = functionAnnotation.name();
			if (!functionName.equals(ScriptFunction.EMPTY)) {
				return functionName;
			}
		}
	 ...
	 */
	public static boolean isCallable(Class<?> clazz, Method method, AbstractScriptEngine scriptEngine) {
	...
	private static boolean isSupportedAndValid(Class<? extends Annotation> annotationType, String classOption, Class<?> clazz, Member member, AbstractScriptEngine scriptEngine) {
