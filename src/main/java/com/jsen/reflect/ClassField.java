	...
	public Object get(Object object) {
		...
		if (member != null && !override) {
			try {
				...
				throw new UnknownException("Unable to get field " + member.getName(), e);
			}
		} else {
			try {
				value = fieldGetterMethod.invoke(object);
			} catch (Exception e) {
				throw new UnknownException("Unable to invoke getter " + fieldSetterMethod.getName(), e);
			}
		}
	...
	public void set(Object object, Object value) {		
		...
		if (member != null && !override) {
			try {
				...
				throw new UnknownException("Unable to set field " + member.getName(), e);
			}
		} else {
			...
			try {
				...
				throw new UnknownException("Unable to invoke setter " + fieldSetterMethod.getName(), e);
			}
		}
	}	
