...
public abstract class AbstractScriptEngine extends javax.script.AbstractScriptEngine {
	...
	protected AbstractScriptEngineFactory factory;
	 ...
	 */
	protected AbstractScriptEngine(AbstractScriptEngineFactory factory, ScriptSettings scriptSettings) {
	 ...
	 */
    public AbstractScriptEngineFactory getBrowserFactory() {
		return factory;
	}
