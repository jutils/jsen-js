...
import com.jsen.misc.MimeContentFactoryBase;
 ...
 * @since 0.9 - 21.4.2014
 */
public abstract class AbstractScriptEngineFactory extends MimeContentFactoryBase<AbstractScriptEngine> implements ScriptEngineFactory {
	 ...
	 */
	public AbstractScriptEngine getBrowserScriptEngine(ScriptSettings scriptSettings) {
		AbstractScriptEngine scriptEngine = getBrowserScriptEngineProtected(scriptSettings);
	...
	@Override
	public AbstractScriptEngine getContent(Object... args) {
	 ...
	 */
	protected synchronized void installScriptContextInjects(AbstractScriptEngine scriptEngine) {
	 ...
	 * @return New constructed script engine with a given script settings.
	 */
	protected abstract AbstractScriptEngine getBrowserScriptEngineProtected(ScriptSettings scriptSettings);
}
