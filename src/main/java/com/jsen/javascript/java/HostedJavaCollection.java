...
public class HostedJavaCollection extends HostedJavaObject {
	 ...
	 * @param objectMembers Object members.
	 */
	public HostedJavaCollection(Scriptable scope, ObjectMembers objectMembers) {
		super(scope, objectMembers);
	}
	
	public HostedJavaCollection(Scriptable scope, Object object) {
		super(scope, object);
	}
	...
	public Object get(int index, Scriptable start) {
		...
		return customFinalizeGet(object);
	}
	...
	@Override
	protected Object finalizeGet(Object result) {
		return result;
	}
	
	protected Object customFinalizeGet(Object result) {
