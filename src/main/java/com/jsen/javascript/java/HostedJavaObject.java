...
public class HostedJavaObject extends ObjectScriptable implements Wrapper, Function {
	...
	public Scriptable construct(Context cx, Scriptable scope, Object[] args) {
		...
		try {
			...
			throw new UnknownException("Unable to construct object " + nearestConstructorMember.getName(), e);
		}
	...
	protected Object wrapObject(Object object) {		
		return JavaScriptEngine.javaToJS(object, this);
	}
