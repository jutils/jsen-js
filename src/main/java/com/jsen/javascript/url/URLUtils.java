package com.jsen.javascript.url;
...
import com.jsen.core.annotation.ScriptSetter;
...
public class URLUtils {
	...
	public void setHref(String href) {
		...
		if (contextObject.getClass().equals(com.jsen.javascript.url.URL.class) && url == null) {
